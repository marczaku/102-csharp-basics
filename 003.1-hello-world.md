...
- **The cleanest way:** Use Microsoft‘s `dotnet console` command
  - Open your Command Line. On Mac/Linux: `Terminal` on Windows: `Command Line` or short: `cmd`
  - First, use `cd path/to/directory` to move to the desired folder
    - e.g.: `cd C:\Projects\` or `cd ~/Projects/`
...
- Move to the newly coreated project folder: `cd HelloWorld`
- Use the command `dotnet run` to run your new application
- Observe the output:

<img width="476" alt="image" src="https://user-images.githubusercontent.com/7360266/134827043-c4092c0d-0a01-4fc1-8bbb-6957abeb9006.png">
