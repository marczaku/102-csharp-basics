...
// There is a variable name and a value is assigned to it (like a phone number)
string marc = "07081716161"

// Now, if I use that variable, then the value (the phone number) for that contact is used:
Console.WriteLine(marc); // Output: 07081716161
Console.WriteLine("marc"); // Output: marc

// We can have different variables with different values, too:
string anna = "07303937390"

// Also, we can assign new values to existing variables:
